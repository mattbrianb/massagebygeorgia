...
export default function WhatsAppFloating() {
  ...
  const whatsappNumber = "27794808977";
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 lg:bottom-10 lg:right-10 z-50 bg-olive-700 text-white p-5 rounded-full shadow-lg shadow-olive-900/30 hover:opacity-90 hover:scale-110 transition-all flex items-center justify-center group"
